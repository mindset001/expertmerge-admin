...
const reportedAccountsData = [
    { 
      ...
      profileLink: '/profile/minerva-barnett' 
    },
    { 
      id: 2, 
      name: 'John Doe', 
    ...
    { 
      ...
      profileLink: '/profile/robert-brown' 
    },
    { 
      id: 5, 
      name: 'Emma Watson', 
      address: 'Liverpool, United Kingdom', 
      phone: '+44 7912 123456', 
      email: 'emmawatson@mail.com',
      profileLink: '/profile/emma-watson' 
    },
    { 
      id: 6, 
      name: 'Olivia Johnson', 
      ...
      email: 'olivia.johnson@yahoo.com',
      profileLink: '/profile/olivia-johnson' 
    },
    { 
      id: 7, 
      name: 'William Martinez', 
      address: 'Cardiff, United Kingdom', 
      phone: '+44 7945 123456', 
      email: 'willmartinez@outlook.com',
      profileLink: '/profile/william-martinez' 
    },
    { 
      id: 8, 
      name: 'Sophia Davis', 
      address: 'Bristol, United Kingdom', 
      phone: '+44 7988 123456', 
      email: 'sophiadavis@gmail.com',
      profileLink: '/profile/sophia-davis' 
    },
    { 
      id: 9, 
      name: 'Lucas Taylor', 
      address: 'Leeds, United Kingdom', 
      phone: '+44 7855 123456', 
      email: 'lucastaylor@example.com',
      profileLink: '/profile/lucas-taylor' 
    },
    { 
      id: 10, 
      name: 'Isabella Wilson', 
      address: 'Glasgow, United Kingdom', 
      phone: '+44 7919 123456', 
      email: 'isabellawilson@mail.com',
      profileLink: '/profile/isabella-wilson' 
    },
    { 
      id: 11, 
      name: 'Mason Harris', 
      address: 'Sheffield, United Kingdom', 
      phone: '+44 7822 123456', 
      email: 'masonharris@gmail.com',
      profileLink: '/profile/mason-harris' 
    },
    { 
      id: 12, 
      name: 'Amelia Garcia', 
      ...
      email: 'amelia.garcia@yahoo.com',
      profileLink: '/profile/amelia-garcia' 
    },
    { 
      id: 13, 
      name: 'James Johnson', 
      address: 'Nottingham, United Kingdom', 
      phone: '+44 7755 123456', 
      email: 'jamesjohnson@outlook.com',
      profileLink: '/profile/james-johnson' 
    },
    { 
      id: 14, 
      name: 'Emily Brown', 
      address: 'Liverpool, United Kingdom', 
      phone: '+44 7733 123456', 
      email: 'emily.brown@email.com',
      profileLink: '/profile/emily-brown' 
    },
    { 
      id: 15, 
      name: 'Henry White', 
      address: 'Coventry, United Kingdom', 
      phone: '+44 7699 123456', 
      email: 'henrywhite@gmail.com',
      profileLink: '/profile/henry-white' 
    },
    { 
      id: 16, 
      name: 'Charlotte Davis', 
      address: 'Brighton, United Kingdom', 
      phone: '+44 7644 123456', 
      email: 'charlottedavis@gmail.com',
      profileLink: '/profile/charlotte-davis' 
    },
    { 
      id: 17, 
      name: 'Daniel King', 
      address: 'Glasgow, United Kingdom', 
      phone: '+44 7600 123456', 
      email: 'danielking@yahoo.com',
      profileLink: '/profile/daniel-king' 
    },
    { 
      id: 18, 
      name: 'Victoria Lewis', 
      address: 'Southampton, United Kingdom', 
      phone: '+44 7599 123456', 
      email: 'victorialewis@example.com',
      profileLink: '/profile/victoria-lewis' 
    },
    { 
      id: 19, 
      name: 'Alexander Walker', 
      address: 'Plymouth, United Kingdom', 
      phone: '+44 7544 123456', 
      email: 'alexanderwalker@mail.com',
      profileLink: '/profile/alexander-walker' 
    },
    { 
      id: 20, 
      name: 'Ella Thompson', 
      address: 'Cardiff, United Kingdom', 
      phone: '+44 7533 123456', 
      email: 'ellathompson@gmail.com',
      profileLink: '/profile/ella-thompson' 
    }
  ];
    ...
    <div className="w-full border bg-white  rounded-lg p-4">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center">
          <h1 className="text-2xl font-bold mr-4 text-[#1D2739]">Accounts Deleted</h1>
          <Button
            icon={<ReloadOutlined />}
